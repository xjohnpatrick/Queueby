        ...
        <div className="flex flex-col relative justify-center w-full">
          <div className={`flex flex-col text-center ${montserrat.className}`}>
            ...
            <div className="flex flex-col leading-4">
              ...
              <span className="md:text-lg">Tel. No. 7738-1883 / 7754-3045</span>
            </div>
          ...
          <div className={`flex w-full h-full pt-12 ${montserrat.className}`}>
                ...
                <div className="flex flex-col mb-3" key={id}>
                  {position === "Punong Barangay" ? (
                    <>
                      ...
                      <span className="italic font-bold uppercase text-[12px]">
                        {position}
                      </span>
                    </>
                  ) : position === "Kagawad" ? (
                    ...
                    position !== "Barangay Secretary" && (
                      <>
                        ...
                        {committees.map((committee, index) => (
                          <span className="italic text-[10px]" key={index}>
                            {committee}
                          </span>
                        ))}
                      </>
            ...
            <div className="flex flex-col items-center relative w-3/4">
              <span className="italic text-sm absolute right-0 top-0 font-bold">
                Date(<span contentEditable>mm</span>/
                <span contentEditable>dd</span>/
                <span contentEditable>yyyy</span>)
                <span className="text-red-500">*</span>
              </span>
              <span className="text-2xl absolute right-0 top-5 font-bold italic uppercase">
                {title}
              </span>

              <div className="flex relative flex-col w-full h-full mt-6 py-12 pl-6">
                <div className="flex flex-col">
                  <span className="uppercase font-bold text-sm italic mt-2">
                    This is to certify that {/*Editable Text*/}
                    <span
                      className="font-bold text-sm italic normal-case underline"
                      contentEditable
                    >
                  ...
                  <span className="font-bold text-sm italic indent-6 mt-6">
                ...
                <div className="flex flex-col mt-6">
                  ...
                  <span
                    className="flex font-bold italic uppercase my-5 justify-center text-sm text-center"
                    contentEditable
                  >
                  ...
                  <span className="flex justify-center italic font-bold text-sm mt-5">
                    This certification/clearance is issued upon request in
                    connection with
                  </span>
                  <span className="flex justify-center italic font-bold text-sm mt-5 uppercase">
                    Requirements
                  </span>
                ...
                {committeeMembers
                  ...
                  .map(({ id, name, position }) => (
                    ...
                    >
                      ...
                      <span className="text-sm italic font-bold text-center">
                        {position}
                      </span>
                    </div>
                  ))}
