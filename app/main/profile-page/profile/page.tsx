...
const Profile = () => {
  return (
    <div className="h-[1000px] w-full bg-blue-100 flex items-center justify-center">
      <div className="flex flex-col justify-center lg:flex-row h-[700px] lg:h-[600px] w-full sm:w-[630px] md:w-[758px] lg:w-[70vw] mx-4 bg-white rounded-md lg:py-16">
        <div className="flex flex-col justify-center lg:justify-normal lg:w-1/2 lg:border-r-medium lg:border-b-0 border-b-medium border-blue-400 h-3/4 lg:h-full">
          <div className="flex flex-col items-center mb-4">
            ...
            <div className="mt-6 mb-4 w-32 h-32 relative">
          ...
          <div className="flex flex-col items-center justify-center text-lg lg:text-3xl gap-4 font-bebas h-full">
            <div className="flex flex-col lg:flex-row items-center gap-4">
              ...
              <p className="text-blue-400 text-lg lg:text-2xl break-all">
