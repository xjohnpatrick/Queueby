  ...
  return (
    <div className='flex items-center justify-center h-screen w-full bg-blue-100'>
        <div className="flex relative justify-center bg-white w-[75vw] lg:w-[60vw] h-[90vh] lg:h-[80vh] rounded-md">
            ...
            <div className={`flex flex-col w-full lg:w-[50vw] items-center lg:gap-12 ${bebasNeue.className}`}>
                
                <h1 className='flex text-4xl xl:text-5xl text-blue-400 mt-12 mb-4 text-center'>Create Admin Account</h1>
