...
const BarangayCertFirstTimeJobSeeker = () => {
  ...
  return (
    <div className='flex flex-col h-[1550px] w-full items-center'>
      <h1 className={`flex text-4xl font-semibold my-8 ${montserrat.className}`}>Barangay Certicate for First Time Job Seeker</h1>
          ...
          <div className={`flex w-full h-full pt-12 ${montserrat.className}`}>
            ...
            <div className="flex flex-col items-center relative w-3/4">
                <span className='italic text-sm absolute right-0 top-0 font-bold'>
                  Date(<span contentEditable>mm</span>/<span contentEditable>dd</span>/<span contentEditable>yyyy</span>)
                <span className='text-red-500'>*</span>
                </span>
                <span className="text-xl absolute right-0 top-5 font-bold italic uppercase">Barangay Certicate for First Time Job Seeker</span>
              ...
              <div className='flex relative flex-col w-full h-full mt-6 py-12 pl-6'>
                ...
                <span className='uppercase font-bold text-sm italic'>This is to certify that{" "}
                    ...
                    <span
                      ...
                      _____________________________________<span className='text-red-500'>*</span>
                    </span>
