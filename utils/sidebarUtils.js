...
const getRecordsButtons = () => {
    return [
        ...
        { text: 'Pending Records', onClick: () => console.log('Pending Records') },
        { text: 'To Receive Records', onClick: () => console.log('To Receive Records') },
        { text: 'Completed Records', onClick: () => console.log('Completed Records') },
    ];
};
...
const getDatabaseButtons = () => {
    return [
        { text: 'User Information', onClick: () => console.log('User Information') },
        { text: 'User Transaction', onClick: () => console.log('User Transaction') },
        { text: 'Announcement', onClick: () => console.log('Announcement') },
        { text: 'Barangay Officials', onClick: () => console.log('Barangay Officials') },
    ];
};
